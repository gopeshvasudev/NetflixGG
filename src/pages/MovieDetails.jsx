  ...
  return (
    <main id="details-main" className="main w-full text-white" style={styles}>
      <div className="w-full min-h-screen bg-black/85 flex flex-col gap-5 md:flex-row pt-24 px-2">
        <section className="left w-full md:w-1/2 h-[500px] md:h-[460px] flex justify-center md:justify-end lg:pr-28">
          <div className="image w-11/12 sm:w-6/12 md:w-10/12 lg:w-[340px] bg-red-300 h-full overflow-hidden rounded-xl">
            <img
        ...
        <section className="right w-full md:w-1/2 flex flex-col items-center md:items-start">
          ...
          {status == "Released" && (
            <Link
              ...
              className="font-semibold text-sm bg-[#ED1C28] p-2 rounded-lg mb-5"
            >
              Watch Now
            </Link>
          )}
